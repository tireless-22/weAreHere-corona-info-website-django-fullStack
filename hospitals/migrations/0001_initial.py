    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_no_of_ambulance_driver', models.BigIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('pincode', models.IntegerField()),
                ('address', models.CharField(max_length=100)),
                ('gmap_link', models.CharField(max_length=2048)),
                ('amb_img', models.ImageField(default='ambulance.png', upload_to='')),
            ],
        ),
        migrations.CreateModel(
            name='District',
            fields=[
                ...
                ('dist_img', models.ImageField(default='blank', upload_to='district/images')),
            ],
        ),
        migrations.CreateModel(
            name='Hospital',
            fields=[
                ...
                ('hosp_img', models.ImageField(default='hosp.png', upload_to='hospital/images')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_no_of_the_medical_shop_owner', models.BigIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('pincode', models.IntegerField()),
                ('address', models.CharField(max_length=100)),
                ('gmap_link', models.CharField(max_length=2048)),
                ('med_img', models.ImageField(default='med.png', upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_no_of_the_oxygen_dealer', models.BigIntegerField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('pincode', models.IntegerField()),
                ('address', models.CharField(max_length=100)),
                ('gmap_link', models.CharField(max_length=2048)),
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospitals.district')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.BigIntegerField(validators=[django.core.validators.MaxLengthValidator(10), django.core.validators.MinLengthValidator(10)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('medical_store', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hospitals.medicines')),
            ],
        ),
        migrations.CreateModel(
            name='Reviews_hospital',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('username', models.CharField(max_length=20)),
                ('rating', models.IntegerField(validators=[django.core.validators.MaxValueValidator(5)])),
